/* eslint-disable camelcase,@typescript-eslint/no-use-before-define,@typescript-eslint/no-shadow */
...
import type { LiteClient } from './client';
...
export function createLiteClientProvider(
  ...
  return {
    async getState(): Promise<ContractState> {
      ...
      } else if (state.state?.storage.state.type === 'uninit' || state.state === null) {
        storage = {
          type: 'uninit',
        };
        //
